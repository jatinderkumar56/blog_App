...
import LikeButton from "../comment/like-cooment-page";
import CommentForm from "../comment/comment-form";
import CommentList from "../comment/comment-list-page";
...
export async function SingleArticleDetailPage({ article }: ArticleDetailPageProps) {
